...
<head>
    ...
    <title>Bohemian Bliss - LuxTouch Events</title>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .logo-title {
            ...
            font-size: 48px;
            background: linear-gradient(90deg, #c9a78a, #e0c9b8);
        ...
        .modern-nav .ser-btn {
            ...
            border-radius: 50px;
            font-weight: 600;
            box-shadow: 0 6px 22px rgba(201,167,138,0.4);
        ...
        .modern-nav .ser-btn:hover {
            ...
            box-shadow: 0 14px 35px rgba(201,167,138,0.6);
        }
        ...
        .modal-nav-btn {
            ...
            height: 60px;
            border: none;
            background: rgba(201, 167, 138, 0.9);
            color: white;
            font-size: 2rem;
            border-radius: 50%;
            cursor: pointer;
        ...
        .form-group textarea:focus {
            outline: none;
            border-color: var(--primary);
            box-shadow: 0 0 0 4px rgba(201,167,138,0.1);
        }
        ...
        .submit-btn:hover {
            ...
            box-shadow: 0 15px 40px rgba(201,167,138,0.4);
        }
...
<div id="imageModal" class="modal">
    <div class="modal-content">
        <div class="modal-header">
            <h2 class="modal-title">Bohemian Bliss Gallery</h2>
...
<section id="intro-section">
    <div class="carousel-list">
        <div class="carousel-item">
            <img src="img/w6.jpg" alt="Autumn Boho Garden">
            <div class="carousel-content">
                <div class="carousel-title">Autumn Garden</div>
                <div class="carousel-topic">Boho Chic Vibe</div>
                <div class="carousel-description">Stylish bohemian decor with fall blooms and pampas grass</div>
            </div>
        </div>
        <div class="carousel-item">
            <img src="img/b1.jpg" alt="Dreamy Boho Setup">
            <div class="carousel-content">
                <div class="carousel-title">Fairy Lights Magic</div>
                <div class="carousel-topic">Rugs & Lanterns</div>
                <div class="carousel-description">Cozy boho atmosphere with fairy lights and natural elements</div>
            </div>
        </div>
        <div class="carousel-item">
            <img src="img/b2.jpg" alt="Pampas Arch Decor">
            <div class="carousel-content">
                <div class="carousel-title">Elegant Arch</div>
                <div class="carousel-topic">Dried Flowers</div>
                <div class="carousel-description">Wedding arch adorned with pampas and dried flowers in earthy tones</div>
            </div>
        </div>
        <div class="carousel-item">
            <img src="img/b4.jpg" alt="Rattan Lanterns">
            <div class="carousel-content">
                <div class="carousel-title">Rattan Glow</div>
                <div class="carousel-topic">Bohemian Beauty</div>
                <div class="carousel-description">Magical rattan lanterns and natural wood elements</div>
            </div>
        </div>
        <div class="carousel-item">
            <img src="https://static.vecteezy.com/system/resources/previews/061/000/617/non_2x/dreamy-outdoor-wedding-altar-installation-with-natural-wooden-arch-intricate-macrame-tapestry-and-luxurious-pampas-grass-against-mountainous-landscape-at-dusk-photo.jpeg" alt="Dreamy Outdoor Altar">
            <div class="carousel-content">
                <div class="carousel-title">Dreamy Altar</div>
                <div class="carousel-topic">Macrame & Pampas</div>
                <div class="carousel-description">Natural wooden arch with intricate macrame and luxurious pampas grass</div>
            </div>
        </div>
    </div>
...
<section id="details-section">
    <div class="details-container">
        <h2 class="section-title">About Bohemian Bliss Design</h2>

        <p class="description">
            Bohemian Bliss captures the essence of free-spirited romance with natural textures, pampas grass, macrame details,
            earthy tones, and flowing fabrics. This style blends rustic charm with elegant touches—perfect for outdoor or garden weddings.
            Think dreamcatchers, fairy lights, wooden accents, and abundant greenery for a relaxed, magical atmosphere that feels
            authentic and deeply personal. Ideal for couples seeking a laid-back yet stunning celebration surrounded by nature's beauty.
        </p>
        ...
        <div class="request-form">
            ...
            <form id="decorRequestForm" method="POST">
                <input type="hidden" name="decor_id" value="1">
...
<div id="successModal" class="success-modal">
    <div class="success-modal-content">
        ...
        <p>Thank you! We will contact you soon to discuss the details of "Bohemian Bliss" décor for your wedding.</p>
...
<script>
    const images = [
        { src:"img/w6.jpg", title: "Autumn Garden", description: "Boho Chic Vibe" },
        { src:"img/b1.jpg", title: "Fairy Lights Magic", description: "Rugs & Lanterns" },
        { src:"img/b2.jpg", title: "Elegant Arch", description: "Dried Flowers" },
        { src:"img/b4.jpg", title: "Rattan Glow", description: "Bohemian Beauty" },
        { src: "https://static.vecteezy.com/system/resources/previews/061/000/617/non_2x/dreamy-outdoor-wedding-altar-installation-with-natural-wooden-arch-intricate-macrame-tapestry-and-luxurious-pampas-grass-against-mountainous-landscape-at-dusk-photo.jpeg", title: "Dreamy Altar", description: "Macrame & Pampas" }
    ];
