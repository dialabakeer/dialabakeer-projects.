                    ...
                    <div class="mega-container">
                        <div class="mega-left">
                            ...
                            <div class="mega-services-grid">
                                ...
                                <a href="cake.html" class="mega-service-item">Cakes</a>
...
<section id="intro-section">
    <div class="carousel-list">
        <div class="carousel-item">
            <img src="../weddingplaner2/home4/img/w44.jpg" alt="Classic Luxury 2">
        ...
        <div class="carousel-item">
            <img src="../weddingplaner2/home4/img/w22.jpg" alt="Classic Luxury 3">
            <div class="carousel-content">
        ...
        <div class="carousel-item">
            <img src="img/w11.jpg" alt="Classic Luxury 4">
            <div class="carousel-content">
        ...
        <div class="carousel-item">
            <img src="img/w1.jpg" alt="Classic Luxury 5">
            <div class="carousel-content">
...
<section id="details-section">
    <div class="details-container">
        ...
        <p class="description">
            Modern Elegance embodies the essence of contemporary sophistication and understated luxury. This timeless style
            combines clean architectural lines, premium minimalist decor, neutral palettes with subtle textures,
            and intentional negative space to create a serene yet impactful atmosphere. Perfect for couples who
            appreciate modern design, high-end simplicity, and a celebration that feels effortlessly chic.
            Every detail is thoughtfully curated to deliver an unforgettable experience of refined beauty and modern grace.
        </p>
        ...
        <div class="request-form">
            ...
            <form id="decorRequestForm" method="POST">
                <input type="hidden" name="decor_id" value="3">
...
<div id="successModal" class="success-modal">
    <div class="success-modal-content">
        ...
        <p>Thank you! We will contact you soon to discuss the details of "modern" décor for your wedding.</p>
...
<script>
    const images = [
        { src:"../weddingplaner2/home4/img/w44.jpg", title: "Floral Paradise", description: "Luxury Blooms" },
        { src:"../weddingplaner2/home4/img/w22.jpg", title: "Golden Dreams", description: "Royal Setting" },
        { src:"img/w11.jpg", title: "Glamorous Venue", description: "Perfect Setting" },
        { src:"img/w1.jpg", title: "Chandelier Magic", description: "Sparkling Splendor" }
    ];
